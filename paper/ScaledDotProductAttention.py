...
from train_teacher import parse_option
from util.tool import load_teacher
...
if __name__ == '__main__':
    ...
    # b, c, h, w = t_input.size()
    # t_input = t_input.view(2, 32, h * w)
    # s_input = t_input.view(2, 32, h * w)
    # sa = ScaledDotProductAttention(d_model=256, d_k=256, d_v=256, h=8)
    # s_output = sa(s_input, t_input, s_input)
    # print(s_output.shape)
    # s_output = s_output.contiguous().view(b, c, h, w)
    # print(s_output.shape)
