...
def train_distill(epoch, train_loader, module_list, criterion_list, optimizer, opt):
    ...
    for idx, data in enumerate(train_loader):
        ...
        if opt.distill == 'kd':
            ...
            # f_t, f_s, g_t, g_s, se_g_t, se_g_s, cov_m_t, cov_m_s = module_list[1](feat_t, feat_s, error_index)
            # loss_kd = criterion_kd(f_t, f_s, g_t, g_s, se_g_t, se_g_s, cov_m_t, cov_m_s)

            cov_m_t, cov_m_s = module_list[1](feat_t, feat_s, error_index)
            loss_kd = criterion_kd(cov_m_t, cov_m_s)
