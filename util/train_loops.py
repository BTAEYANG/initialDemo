...
def train_distill(epoch, train_loader, module_list, criterion_list, optimizer, opt):
    ...
    for idx, data in enumerate(train_loader):
        ...
        if opt.distill == 'kd':
            ...
            t_dot_tensor, s_dot_tensor, t_pearson_tensor, s_pearson_tensor = module_list[1](feat_t, feat_s)
            loss_kd = criterion_kd(t_dot_tensor, s_dot_tensor, t_pearson_tensor, s_pearson_tensor)
        else:
