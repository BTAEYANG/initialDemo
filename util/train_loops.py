...
def train_distill(epoch, train_loader, module_list, criterion_list, optimizer, opt):
    ...
    for idx, data in enumerate(train_loader):
        ...
        if opt.distill == 'kd':
            ...
            t_stage_pearson, s_stage_pearson, t_matrix_relation, s_matrix_relation, t_sample_relation, s_sample_relation= module_list[1](feat_t[:-1], feat_s[:-1])
            loss_kd = criterion_kd(t_stage_pearson, s_stage_pearson, t_matrix_relation, s_matrix_relation, t_sample_relation, s_sample_relation)
        else:
