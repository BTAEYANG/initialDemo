...
# FPD+KD
CUDA_VISIBLE_DEVICES=0 python train_student.py --path_t ./save/models/resnet32x4_vanilla/ckpt_epoch_240.pth --distill FPD --model_s resnet8x4 -r 0.1 -a 0.8 -b 0.1 --trial 1
